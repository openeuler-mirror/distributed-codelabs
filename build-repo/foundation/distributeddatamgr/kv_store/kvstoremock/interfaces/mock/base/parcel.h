...
public:
    ...
    const std::u16string ReadString16WithLength(int32_t &readLength);

    bool RewindRead(size_t newPosition);

    bool RewindWrite(size_t newPosition);
    ...
    void InjectOffsets(size_t offsets, size_t offsetSize);
...
private:
    ...
    bool WriteObjectOffset(size_t offset);
