...
namespace DistributeddbNbAutolaunch {
#ifdef NB_AUTOLAUNCH
...
class DistributeddbNbAutolaunchTest  : public testing::Test {
public:
...
void DistributeddbNbAutolaunchTest ::SetUpTestCase(void)
{
    SetDir(DistributedDBConstant::NB_DIRECTOR);
}

void DistributeddbNbAutolaunchTest ::TearDownTestCase(void)
{
}

void DistributeddbNbAutolaunchTest ::SetUp(void)
{
...
void DistributeddbNbAutolaunchTest ::TearDown(void)
{
}
 ...
 */
#ifdef NB_AUTOLAUNCH
HWTEST_F(DistributeddbNbAutolaunchTest, ParamCheck001, TestSize.Level0)
{
    string schema = SpliceToSchema(VALID_VERSION_1, VALID_MODE_1, VALID_DEFINE_1, VALID_INDEX_1);
    AutoLaunchOption option = {true, false, CipherType::DEFAULT, NULL_PASSWD, schema, true,
        DistributedDBConstant::NB_DIRECTOR, nullptr};
 ...
 * @tc.author: fengxiaoyun
 */
HWTEST_F(DistributeddbNbAutolaunchTest, ParamCheck002, TestSize.Level0)
{
    KvStoreDelegateManager *manager = new (std::nothrow) KvStoreDelegateManager(APP_ID_1, USER_ID_1);
    ASSERT_NE(manager, nullptr);
    EXPECT_EQ(manager->SetKvStoreConfig({ .dataDir = DistributedDBConstant::NB_DIRECTOR }), OK);
    /**
     * @tc.steps: step1. call EnableKvStoreAutoLaunch use the option with which createIfNecessary is false,
     *  dataDir is NB_DIRECTOR and observer is TheAppoitObserver
    ...
    option.dataDir = DistributedDBConstant::NB_DIRECTOR;
    option.observer = observer;
    EXPECT_NE(manager->EnableKvStoreAutoLaunch(USER_ID_1, APP_ID_1, STORE_ID_1, option, nullptr), OK);
    /**
     * @tc.steps: step2. call EnableKvStoreAutoLaunch use the option with which createIfNecessary is true,
 ...
 * @tc.author: fengxiaoyun
 */
HWTEST_F(DistributeddbNbAutolaunchTest, ParamCheck003, TestSize.Level0)
{
    KvStoreDelegateManager *manager = new (std::nothrow) KvStoreDelegateManager(APP_ID_1, USER_ID_1);
    ASSERT_NE(manager, nullptr);
    EXPECT_EQ(manager->SetKvStoreConfig({ .dataDir = DistributedDBConstant::NB_DIRECTOR }), OK);
     ...
     */
    AutoLaunchOption option = {true, true, CipherType::DEFAULT, NULL_PASSWD, "", true,
        DistributedDBConstant::NB_DIRECTOR, nullptr};
    ...
    /**
     * @tc.steps: step3. call EnableKvStoreAutoLaunch use the option with which createIfNecessary is true,
    ...
    EXPECT_EQ(manager->DeleteKvStore(STORE_ID_1), OK);
    /**
     * @tc.steps: step4. call EnableKvStoreAutoLaunch use the option with which createIfNecessary is true,
    ...
    /**
     * @tc.steps: step5. call EnableKvStoreAutoLaunch use the option with which createIfNecessary is true,
 ...
 * @tc.author: fengxiaoyun
 */
HWTEST_F(DistributeddbNbAutolaunchTest, ParamCheck004, TestSize.Level0)
{
    /**
    ...
    AutoLaunchOption option = {false, false, CipherType::DEFAULT, passwd1, schema, false,
        DistributedDBConstant::NB_DIRECTOR, nullptr};
    ...
    option = {false, true, CipherType::DEFAULT, passwd2, schema, false, DistributedDBConstant::NB_DIRECTOR, nullptr};
    EXPECT_EQ(manager->EnableKvStoreAutoLaunch(USER_ID_1, APP_ID_1, STORE_ID_1, option, nullptr),
        INVALID_PASSWD_OR_CORRUPTED_DB);
     ...
     */
    option = {false, true, CipherType::DEFAULT, passwd1, schema, false, DistributedDBConstant::NB_DIRECTOR, nullptr};
    EXPECT_EQ(manager->EnableKvStoreAutoLaunch(USER_ID_1, APP_ID_1, STORE_ID_1, option, nullptr), OK);
    EXPECT_EQ(manager->DisableKvStoreAutoLaunch(USER_ID_1, APP_ID_1, STORE_ID_1), OK);
     ...
     */
    passwd2.SetValue(PASSWD_VECTOR_2.data(), PASSWD_VECTOR_2.size());
    option = {false, false, CipherType::DEFAULT, passwd2, schema, false, DistributedDBConstant::NB_DIRECTOR, nullptr};
 ...
 * @tc.author: fengxiaoyun
 */
HWTEST_F(DistributeddbNbAutolaunchTest, ParamCheck005, TestSize.Level0)
{
    KvStoreDelegateManager *manager = new (std::nothrow) KvStoreDelegateManager(APP_ID_1, USER_ID_1);
    ASSERT_NE(manager, nullptr);
    EXPECT_EQ(manager->SetKvStoreConfig({ .dataDir = DistributedDBConstant::NB_DIRECTOR }), OK);
     ...
     */
    string schema = SpliceToSchema(VALID_VERSION_1, VALID_MODE_1, VALID_DEFINE_1, VALID_INDEX_1);
    AutoLaunchOption option = {true, false, CipherType::DEFAULT, NULL_PASSWD, schema, false,
        DistributedDBConstant::NB_DIRECTOR, nullptr};
    EXPECT_EQ(manager->EnableKvStoreAutoLaunch(USER_ID_1, APP_ID_1, STORE_ID_1, option, nullptr), OK);
    EXPECT_EQ(manager->DisableKvStoreAutoLaunch(USER_ID_1, APP_ID_1, STORE_ID_1), OK);
    EXPECT_EQ(manager->DeleteKvStore(STORE_ID_1), OK);
    ...
    option = {true, false, CipherType::DEFAULT, NULL_PASSWD, inValidSchema, false,
        DistributedDBConstant::NB_DIRECTOR, nullptr};
    EXPECT_EQ(manager->EnableKvStoreAutoLaunch(USER_ID_1, APP_ID_1, STORE_ID_1, option, nullptr),
        INVALID_SCHEMA);
 ...
 * @tc.author: fengxiaoyun
 */
HWTEST_F(DistributeddbNbAutolaunchTest, ParamCheck006, TestSize.Level0)
{
    KvStoreDelegateManager *manager = new (std::nothrow) KvStoreDelegateManager(APP_ID_1, USER_ID_1);
    ASSERT_NE(manager, nullptr);
    EXPECT_EQ(manager->SetKvStoreConfig({ .dataDir = DistributedDBConstant::NB_DIRECTOR }), OK);
    ...
    string tailPathValid(402 - (DistributedDBConstant::NB_DIRECTOR + middlePath).length(), 'e');
    // the length of the invalid string is 504-101 = 403
    string tailPathInvalid(403 - (DistributedDBConstant::NB_DIRECTOR + middlePath).length(), 'h');
    string validLengthDir = DistributedDBConstant::NB_DIRECTOR + middlePath + tailPathValid;
    string inValidLengthDir = DistributedDBConstant::NB_DIRECTOR + middlePath + tailPathInvalid;

    vector<string> dirs = {"", DistributedDBConstant::NB_DIRECTOR + "a\0", validLengthDir, inValidLengthDir,
        DistributedDBConstant::NB_DIRECTOR + "a..b", DistributedDBConstant::NB_DIRECTOR + "a/…b",
        DistributedDBConstant::NB_DIRECTOR + "a/中文", DistributedDBConstant::NB_DIRECTOR + "a\\//&^a%#",
        DistributedDBConstant::NB_DIRECTOR + "diehgid/"};
 ...
 * @tc.author: fengxiaoyun
 */
HWTEST_F(DistributeddbNbAutolaunchTest, ParamCheck007, TestSize.Level0)
{
    KvStoreDelegateManager *manager = new (std::nothrow) KvStoreDelegateManager(APP_ID_1, USER_ID_1);
    ASSERT_NE(manager, nullptr);
    EXPECT_EQ(manager->SetKvStoreConfig({ .dataDir = DistributedDBConstant::NB_DIRECTOR }), OK);
    ...
    /**
     * @tc.steps: step1. call EnableKvStoreAutoLaunch use the option with which createIfNecessary is true and
     *  isEncryptedDb is false
     * @tc.expected: step1. enable success, and return OK.
     */
    KvStoreObserverImpl observer;
    AutoLaunchOption option = {true, false, CipherType::DEFAULT, NULL_PASSWD, "", false,
        DistributedDBConstant::NB_DIRECTOR, &observer};
     ...
     */
    option = {false, false, CipherType::DEFAULT, NULL_PASSWD, "", false, DistributedDBConstant::NB_DIRECTOR, &observer};
    ...
    passwd1.SetValue(PASSWD_VECTOR_1.data(), PASSWD_VECTOR_1.size());
    option = {true, true, CipherType::DEFAULT, passwd1, "", false, DistributedDBConstant::NB_DIRECTOR, &observer};
    EXPECT_EQ(manager->EnableKvStoreAutoLaunch(USER_ID_1, APP_ID_1, STORE_ID_1, option, notifier), ALREADY_SET);
     ...
     */
    string schema = SpliceToSchema(VALID_VERSION_1, VALID_MODE_1, VALID_DEFINE_1, VALID_INDEX_1);
    option = {true, false, CipherType::DEFAULT, NULL_PASSWD, schema, false,
        DistributedDBConstant::NB_DIRECTOR, &observer};
    EXPECT_EQ(manager->EnableKvStoreAutoLaunch(USER_ID_1, APP_ID_1, STORE_ID_1, option, notifier), ALREADY_SET);
     ...
     */
    option = {true, false, CipherType::DEFAULT, NULL_PASSWD, "", true, DistributedDBConstant::NB_DIRECTOR, &observer};
    EXPECT_EQ(manager->EnableKvStoreAutoLaunch(USER_ID_1, APP_ID_1, STORE_ID_1, option, notifier), ALREADY_SET);
    ...
    option = {true, false, CipherType::DEFAULT, NULL_PASSWD, "", false, DistributedDBConstant::NB_DIRECTOR, &observer2};
    EXPECT_EQ(manager->EnableKvStoreAutoLaunch(USER_ID_1, APP_ID_1, STORE_ID_1, option, notifier), ALREADY_SET);
     ...
     */
    option = {true, false, CipherType::DEFAULT, NULL_PASSWD, "", false, DistributedDBConstant::NB_DIRECTOR, &observer};
    EXPECT_EQ(manager->EnableKvStoreAutoLaunch(USER_ID_1, APP_ID_1, STORE_ID_1, option, notifier), ALREADY_SET);
    /**
 ...
 * @tc.author: fengxiaoyun
 */
HWTEST_F(DistributeddbNbAutolaunchTest, ClosedSyncPressure001, TestSize.Level0)
{
    ...
    autoLaunchOption.dataDir = DistributedDBConstant::NB_DIRECTOR;
 ...
 * @tc.author: fengxiaoyun
 */
HWTEST_F(DistributeddbNbAutolaunchTest, AutoLaunch001, TestSize.Level1)
{
