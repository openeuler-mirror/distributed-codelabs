...
#include "unregisterdatachangelistener_fuzzer.h"

namespace OHOS {
    bool FuzzDoUnregisterDataChangeListener(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::FuzzDoUnregisterDataChangeListener(data, size);
    return 0;
}
